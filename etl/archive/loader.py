        ...
        try:
            ...
            for i in range(0, len(df), batch_size):
                ...
                try:
                    ...
                    # Eliminar registros existentes para esta ubicación y fecha (SOLO EN EL PRIMER LOTE)
                    if current_batch == 1 and 'ubicacion_id' in batch_df.columns and 'fecha_extraccion' in batch_df.columns:
